...
def scheme_eval(expr, env, _=None):  # Optional third argument is ignored
    ...
    if scheme_symbolp(first) and first in scheme_forms.SPECIAL_FORMS:
        ...
        # BEGIN PROBLEM 3
            ...
            #return scheme_apply(scheme_eval(expr.first,env),scheme_eval(expr.rest,env),env)
        #return Pair(scheme_eval(expr.first,env),scheme_eval(expr.rest,env))
        new_expr = expr.map(lambda x:scheme_eval(x,env))
